...
`,xi=void 0,Pi=void 0,Ci={code:bi,title:xi,desc:Pi},Si=!0;var ki=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",demoMeta:Ci,isDemo:Si,default:wi}),Ii="/react-photo-view/assets/default-photo.136a6935.svg";function Ai(){return wt(He,{children:[m(Ye,{children:m(We,{src:"",children:m(Pt,{children:"\u65E0\u9ED8\u8BA4\u56FE"})})}),m(Ye,{brokenElement:m(Ma,{src:Ii}),children:m(We,{src:"",children:m(Pt,{children:"\u81EA\u5B9A\u4E49\u9ED8\u8BA4\u56FE"})})})]})}const Mi=`import React from 'react';
import { PhotoProvider, PhotoView } from 'react-photo-view';
