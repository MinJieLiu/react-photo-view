...
`,bi=void 0,xi=void 0,Pi={code:wi,title:bi,desc:xi},Ci=!0;var Si=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",demoMeta:Pi,isDemo:Ci,default:yi}),ki="/assets/default-photo.136a6935.svg";function Ii(){return yt(Ge,{children:[m(He,{children:m(qe,{src:"",children:m(xt,{children:"\u65E0\u9ED8\u8BA4\u56FE"})})}),m(He,{brokenElement:m(Aa,{src:ki}),children:m(qe,{src:"",children:m(xt,{children:"\u81EA\u5B9A\u4E49\u9ED8\u8BA4\u56FE"})})})]})}const Ai=`import React from 'react';
import { PhotoProvider, PhotoView } from 'react-photo-view';
